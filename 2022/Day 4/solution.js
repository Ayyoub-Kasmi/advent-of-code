...
var pairsPromise = (0, utils_1.processInputFile)("input.txt", function (rl) { var _a, rl_1, rl_1_1; return __awaiter(void 0, void 0, void 0, function () {
...
function countOverlappingPairs(pairs) {
    ...
    pairs.forEach(function (pair) {
        var assignmentOne = pair[0].split("-");
        var assignmentTwo = pair[1].split("-");
...
function countContainingPairs(pairs) {
